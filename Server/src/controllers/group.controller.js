...
const addMember = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, updatedGroup, 'User added to group successfully'));
});
...
const removeMember = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, updatedGroup, 'User removed from group successfully'));
});
...
const addAdmin = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, updatedGroup, 'User promoted to admin successfully'));
});
...
const getGroups = asyncHandler(async (req, res) => {
  ...
  if (allGroupsUserIsPartOf.length === 0) {
    return res.status(200).json(new apiResponse(200, {}, 'User is not a member of any groups'));
  }
...
const getGroupsMembersData = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new apiResponse(200, members, 'Groups members data fectched successfully'));
});
