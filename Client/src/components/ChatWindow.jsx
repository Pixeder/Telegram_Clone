      ...
      <div className='flex h-screen w-full flex-col bg-white'>
        ...
        <div className='flex-1 overflow-y-auto bg-gray-50 p-4'>
          {messages.map((message) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex max-w-sm flex-col rounded-lg px-3 py-2 ${isSentByMe ? 'bg-blue-500 text-white' : 'bg-gray-200 text-black'}`}
                >
                  ...
                  {message.fileURL && message.fileType === 'image' && (
                    <img
                      src={message.fileURL}
                      alt='shared message'
                      className='mb-2 w-50 max-w-xs rounded-md'
                    />
                  )}
                  {message.fileURL && message.fileType !== 'image' && (
                    <a
                      ...
                      className='block rounded-md bg-gray-500/20 p-2 hover:underline'
                    >
                      Download File
                    </a>
                  )}
        ...
        <div className='border-t border-gray-200 bg-white p-4'>
          <form onSubmit={handleSubmit(onSendMessage)} className='flex items-center space-x-3'>
            ...
            <Input placeholder='Type a message...' className='flex-1' {...register('message')} />
            <div className='w-40'>
