...
import { FileUploadModal } from './index.js';
  ...
  useEffect(() => {
    ...
    newSocket.on('receive_group_message', (newMessage) => {
      ...
      if (isGroupChat && newMessage.groupId === currentChat?._id) {
        ...
        dispatch(addNotification(newMessage.groupId));
      }
    });
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p
                className={`text-xs transition-colors ${!isGroupChat && isTyping ? 'text-sky-500' : 'text-gray-400 dark:text-slate-400'}`}
              >
          ...
          <div className='flex items-center gap-2 text-gray-500 dark:text-gray-400'>
            <Button
              className='rounded-full p-2 transition-colors hover:bg-gray-300 dark:hover:bg-slate-700'
                  ...
                  >
                    ...
                    {message.fileURL && !message.fileType.startsWith('image/') && (
                      <a
                        ...
                        className='mb-2 block rounded-md bg-black/20 p-2 transition-colors hover:underline dark:bg-white/10'
                      >
                        Download File
                      </a>
                    )}
                    ...
                    <div className='mt-1 flex items-center justify-end gap-1.5'>
                      <p
                        className={`text-xs ${isSentByMe ? 'text-sky-100/80' : 'text-gray-400 dark:text-slate-400'}`}
                      >
          ...
          <form onSubmit={handleSubmit(onSendMessage)} className='flex items-center gap-3'>
            <div className='relative flex items-center'>
              <motion.button
                ...
                className='rounded-full p-2 text-gray-500 transition-colors hover:bg-gray-300 dark:text-gray-400 dark:hover:bg-slate-700'
                title='Attach file'
              >
                {/* Attach Icon */}{' '}
                <svg
              ...
              >
                ...
                >
                  <path
                    strokeLinecap='round'
                    strokeLinejoin='round'
                    d='M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9 9.75a.75.75 0 01.75-.75h.008a.75.75 0 010 1.5H9.75a.75.75 0 01-.75-.75zm4.5 0a.75.75 0 01.75-.75h.008a.75.75 0 010 1.5H14.25a.75.75 0 01-.75-.75z'
                  />
                </svg>
              </motion.button>
              <AnimatePresence>
            ...
            <Input
              ...
              className='flex-1 rounded-lg border-transparent bg-gray-100 px-4 py-2 text-gray-800 transition hover:bg-gray-300 focus:ring-2 focus:ring-sky-500 focus:outline-none dark:bg-slate-700 dark:text-gray-200 dark:hover:bg-slate-500'
              {...register('message')}
            />
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              type='submit'
              className='rounded-lg bg-sky-500 p-3 text-white shadow-sm transition-colors hover:bg-sky-600 disabled:opacity-50'
              title='Send message'
            >
              {/* Send Icon */}{' '}
              <svg
