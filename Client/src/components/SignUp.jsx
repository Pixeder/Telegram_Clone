  ...
  return (
    ...
    <div className='flex min-h-screen items-center justify-center bg-gray-100 p-4 py-12 dark:bg-slate-900'>
      ...
      >
        ...
        {apiError && (
          <p className='rounded-lg bg-red-100 p-3 text-center text-red-600 dark:bg-red-900/50 dark:text-red-400'>
            {apiError}
          </p>
        )}
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
          ...
          <div className='flex items-center space-x-2'>
            <input
              ...
              className='h-4 w-4 rounded border-gray-300 bg-gray-100 text-sky-600 focus:ring-sky-500 dark:border-slate-500 dark:bg-slate-600'
            />
            <label
