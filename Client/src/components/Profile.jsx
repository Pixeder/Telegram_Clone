    ...
    >
      <div className='flex h-full flex-col'>
        ...
        <div className='flex-1 overflow-y-auto'>
          ...
          <div className='grid grid-cols-2 gap-4 border-b border-gray-200 p-6 dark:border-slate-700'>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button
                ...
                bgColor='bg-transparent dark:bg-slate-700'
          ...
          {!isGroupChat && (
            <div className='space-y-4 border-b border-gray-200 p-6 dark:border-slate-700'>
          ...
          {isGroupChat && (
            <div className='flex-1'>
              <h4 className='p-4 text-lg font-semibold text-gray-700 dark:text-gray-200'>
                Members
              </h4>
              {isLoading ? (
                ...
                membersData.map((member) => (
                  <div
                    key={member._id}
                    className='flex items-center px-4 py-3 transition-colors hover:bg-gray-50 dark:hover:bg-slate-700/50'
                  >
                    <img
          ...
          <div className='space-y-4 p-6'>
            ...
            <Button className='w-full rounded-lg p-2 text-left text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-slate-700'>
              Search in conversation
            </Button>
            <Button className='w-full rounded-lg p-2 text-left text-sm text-red-600 hover:bg-red-50 dark:text-red-500 dark:hover:bg-red-900/50'>
              Block User
            </Button>
          </div>
        </div>
