...
const NavItem = ({ icon, active = false, title }) => (
  <button 
    className={`
      w-12 h-12 flex items-center justify-center rounded-lg transition-colors duration-200
      ${active 
...
function IconSidebar() {
  const ChatIcon = (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72A2.122 2.122 0 013 17.286V12.75c0-.97 1.128-2.097 2.097-2.097.884.284 1.5 1.128 1.5 2.097v3.286c0 .878.712 1.5 1.5 1.5h1.5v-6.75c0-.97.616-1.813 1.5-2.097z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2.25A2.25 2.25 0 0014.25 19.5h1.5a2.25 2.25 0 002.25-2.25v-2.25" />
    </svg>
  );
  ...
  return (
    <div className="w-20 bg-slate-800 dark:bg-black p-3 flex flex-col items-center space-y-4">
      <div className="w-12 h-12 bg-sky-500 rounded-lg flex items-center justify-center text-white font-bold text-2xl">
        T
      </div>
