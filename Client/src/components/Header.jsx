      ...
      <nav className='flex items-center justify-between'>
        <div className='mr-4'>
          <Link to='/' className='flex items-center space-x-2'>
            ...
            <span className='hidden text-xl font-bold text-gray-800 dark:text-white sm:inline-block'>TeleClone</span>
          </Link>
        </div>
        ...
        <div className='flex items-center space-x-2 md:space-x-4'>
          <AnimatePresence mode='wait'>
            {isAuthenticated ? (
              ...
              >
                <DarkModeButton />
                <span className='hidden font-medium text-gray-700 dark:text-gray-300 md:inline-block'>
              ...
              >
                ...
                <Link to='/register'>
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className='w-30'>
